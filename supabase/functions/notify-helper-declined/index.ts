// Supabase Edge Function: notify-helper-declined
// Sends email to helper when founder declines their connection request
...
serve(async (req) => {
  ...
  try {
          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: #0a0a0a; padding: 30px; border-radius: 8px;">
              ...
              <p style="color: #a0a0a0; font-size: 16px; line-height: 1.6;">
                Thank you for offering to help with the ${sector} ask on ChiStartupHub.
              </p>
              
              <p style="color: #a0a0a0; font-size: 16px; line-height: 1.6;">
                The founder has decided to go in a different direction at this time. This isn't a reflection of your offer — founders often receive multiple responses and have to make tough choices.
              </p>
              
              <div style="background: #1a1a1a; padding: 20px; border-radius: 6px; margin: 20px 0;">
                <p style="color: #ffffff; font-size: 14px; margin: 0;">
                  💡 Keep an eye on the Founder Asks page for more opportunities to help Chicago founders!
                </p>
              </div>
    ...
    return new Response(
      JSON.stringify({ success: true, message: 'Helper notified of decline' }),
