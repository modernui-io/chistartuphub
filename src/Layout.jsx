...
export default function Layout({ children }) {
  ...
  const hideLayoutFooter = isHomePage || location.pathname === '/funding' || location.pathname === '/about' || location.pathname === '/community' || location.pathname === '/workspaces' || location.pathname === '/events' || location.pathname === '/resources' || location.pathname === '/before-you-start' || location.pathname === '/service-resources' || location.pathname === '/small-business-resources' || location.pathname === '/business-type-explorer' || location.pathname === '/stories' || location.pathname.startsWith('/stories/') || location.pathname === '/WhyChicago' || location.pathname === '/SubmitResource' || location.pathname === '/assessment' || location.pathname === '/profile' || location.pathname === '/saved-resources' || location.pathname === '/settings' || location.pathname === '/accelerators-incubators' || location.pathname === '/contact' || location.pathname === '/admin' || location.pathname === '/Investors';
